...
export default function NewFood({visible, onCancel, onSave, renameItem = 'Name', ingredients: items = null, listName, onSaveIngredi}){

    const [name, setName] = useState(null); //zu Beginn noch keine Eingabe
    const [textInput, setTextInput] = useState(''); 
    const [filteredList, setFilteredList] = useState(null);
    const [ingredientsList, setIngredientsList] = useState(items);
